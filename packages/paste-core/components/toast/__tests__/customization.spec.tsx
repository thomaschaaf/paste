...
describe('Toast data-paste-element attribute', () => {
  it('should set the correct default element prop on Toast', () => {
    ...
    expect(container.querySelector('[data-paste-element="TOAST_ICON_WRAPPER"]')).toBeInTheDocument();
    expect(container.querySelector('[data-paste-element="TOAST_ICON"]')).toBeInTheDocument();
    expect(container.querySelector('[data-paste-element="TOAST_CLOSE_ICON_WRAPPER"]')).toBeInTheDocument();
  ...
  it('should set the correct custom element prop on Toast', () => {
    ...
    expect(container.querySelector('[data-paste-element="FOO_ICON_WRAPPER"]')).toBeInTheDocument();
    expect(container.querySelector('[data-paste-element="FOO_ICON"]')).toBeInTheDocument();
    expect(container.querySelector('[data-paste-element="FOO_CLOSE_ICON_WRAPPER"]')).toBeInTheDocument();
...
describe('Toast customization', () => {
  it('should set styles on default Toast', () => {
    ...
    expect(container.querySelector('[data-paste-element="TOAST_ICON_WRAPPER"]')).toHaveStyleRule(
      'padding-right',
      '1.25rem'
    );
    expect(container.querySelector('[data-paste-element="TOAST_ICON"]')).toHaveStyleRule('color', 'rgb(96,107,133)');
    expect(container.querySelector('[data-paste-element="TOAST_CLOSE_ICON_WRAPPER"]')).toHaveStyleRule(
      'padding-left',
      '1.25rem'
    );
  ...
  it('should set styles on custom element Toast', () => {
    ...
    expect(container.querySelector('[data-paste-element="FOO_ICON_WRAPPER"]')).toHaveStyleRule(
      'padding-right',
      '1.25rem'
    );
    expect(container.querySelector('[data-paste-element="FOO_ICON"]')).toHaveStyleRule('color', 'rgb(96,107,133)');
    expect(container.querySelector('[data-paste-element="FOO_CLOSE_ICON_WRAPPER"]')).toHaveStyleRule(
      'padding-left',
      '1.25rem'
    );
